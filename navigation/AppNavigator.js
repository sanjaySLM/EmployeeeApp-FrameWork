...
export const DocumentNavigator = (props) => {
  return (
    <DocumentStackNavigator.Navigator screenOptions={defaultNavOptions}>
      ...
      />
      <DocumentStackNavigator.Screen name="PdfView" component={PdfViewer} />
      ...
      <PhoenixDrawerNavigator.Screen
        ...
        options={{
          drawerIcon: (props) => (
            <Ionicons
              name={
                Platform.OS === 'android' ? 'person-circle-outline' : 'ios-cart'
              }
              size={28}
              color={props.color}
            />
      ...
      <PhoenixDrawerNavigator.Screen
        ...
        options={{
          drawerIcon: (props) => (
            <Ionicons
              name={
                Platform.OS === 'android' ? 'md-logo-html5' : 'md-logo-html5'
              }
              size={28}
              color={props.color}
            />

...
import { FlatList, View, StyleSheet, SafeAreaView, Text, TextInput, ActivityIndicator, Button } from 'react-native';
...
const PlacesListScreen = props => {
  ...
  console.log('sssssssssssssssssssssssssssssss',places)

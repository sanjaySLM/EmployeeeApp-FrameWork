import { ADD_EMPLOYEE ,EDIT_EMPLOYEE , GET_EMPLOYEE, SEARCH_EMPLOYEE } from '../actions/EmployeeList'
   ...
   export default (state = intialState, action) => {
    switch (action.type) {
      case ADD_EMPLOYEE:
        ...
        return {
            ...state,
            employeeListSearched:state.employeeListSearched.concat(action.employeeDetail)
        ...
        case EDIT_EMPLOYEE :
            const editedEmployeeIndex = state.employeeList.findIndex(emp=> emp.id === action.employeeDetail.id)
